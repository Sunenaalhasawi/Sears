...
import com.hasawi.sears_outlet.databinding.LayoutOfferItemBinding;
...
public class ServicesAdapter extends ArrayAdapter<String> {
    ...
    public ServicesAdapter(@NonNull Context context, int resource, @NonNull ArrayList<String> list) {
