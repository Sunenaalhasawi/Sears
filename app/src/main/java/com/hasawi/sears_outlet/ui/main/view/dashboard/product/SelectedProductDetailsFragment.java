...
import com.hasawi.sears_outlet.data.api.model.pojo.ProductConfigurable;
...
import com.hasawi.sears_outlet.databinding.ActivityImageShowingBinding;
...
import com.hasawi.sears_outlet.ui.main.adapters.ProductSizeAdapter;
import com.hasawi.sears_outlet.ui.main.adapters.RelatedProductsRecyclerviewAdapter;
...
import com.hasawi.sears_outlet.ui.main.viewmodel.ProductDetailViewModel;
import com.hasawi.sears_outlet.utils.PreferenceHandler;
import com.hasawi.sears_outlet.utils.dialogs.CartDialog;
import com.hasawi.sears_outlet.utils.dialogs.ChooseSizeDialog;
import com.hasawi.sears_outlet.utils.dialogs.DisabledCartDialog;
...
//        }
    ...
    private List<String> getColorList(String size) {
        List<String> colorsList = new ArrayList<>();
        for (int i = 0; i < productConfigurableList.size(); i++) {
            ProductConfigurable current = productConfigurableList.get(i);
            if (current.getSize().equalsIgnoreCase(size)) {
                colorsList.add(current.getColor());
            }
        }
        return colorsList;
    }
