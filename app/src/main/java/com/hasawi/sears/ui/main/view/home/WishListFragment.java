...
public class WishListFragment extends BaseFragment {
    ...
    protected void setup() {
        ...
        wishListAdapter = new WishListAdapter() {
            ...
            @Override
            public void onItemClicked(Content product) {
                Content selectedProduct = product;
                Gson gson = new Gson();
    ...
    public void callAddRemoveWishlistApi(Content product, boolean isWishlisted, int position) {
